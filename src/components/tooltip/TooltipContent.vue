...
<template>
  <Transition enter-from-class="scale-75 opacity-0" leave-to-class="scale-75 opacity-0">
    <div
      v-if="state"
      :class="[
        'pointer-events-none fixed z-40 h-8 rounded-v2 bg-on-sur px-3 text-center text-sm/8 text-nowrap text-sur drop-shadow-md transition duration-300 ease-braking',
        {
